...
import questionnaireDn4 from './questionnaire-dn4/questionnaire-dn4.component';
import questionnaireEdas21 from './questionnaire-edas21/questionnaire-edas21.component';
...
angular.module('dentlyApp', [ngCookies, ngResource, ngSanitize, 'btford.socket-io', uiRouter,  uiBootstrap, _Auth, _Fiche, account,
  admin, admin_fonction, list_fiche, user, guest, whoAreWe, whyThisSite,editeurCasClinique, etudes, fichesAnnexes, ficheCliniqueComplete, protocoles, contact, dam_diagnostic, questionnaireIsi, questionnairePsqi, ficheCliniqueDepistageSystematique, ficheCliniqueCompleteVisuel, questionnaireDn4, questionnaireEdas21
